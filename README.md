...
`ok-script-kes` 是 `ok-script` 的修改发行版，并持续同步原项目的最新代码。
...
```powershell
python -m pip install ok-script-kes
```
...
- 开发者 QQ 群：938132715
- [PyPI](https://pypi.org/project/ok-script-kes/)
- [GitHub](https://github.com/baoxin1100/ok-script-kes)
